...
public class BaseServiceImpl<T> implements BaseService<T> , Serializable {
	...
	@Autowired
	protected DtableMapper dtableMapper;
	...
	public Page<T> selectPageUseDyc(Page<T> page) {
		// TODO Auto-generated method stub
		log.info("BaseServiceImpl层："+page.getStart()+"rows: "+page.getRows());
		page.setList(baseMapper.selectPageListUseDyc(page));
		page.setTotalRecord(baseMapper.selectPageCountUseDyc(page));
		log.info("BaseServiceImpl层："+page.getList()+"TotalRecord: "+page.getPageMap());
		return page;
	}
}
